    ...
    <div style={{ position: "fixed", inset: 0, zIndex: 0, pointerEvents: "none", overflow: "hidden" }}>
      ...
      <img 
        ...
        style={{
          ...
          width: "100%",
          height: "auto",
          opacity: 0.35,      /* ADJUST THIS: 0.1 (faint) to 1.0 (full color) */
          objectFit: "cover",
          /* Optional: Adds a soft dream-like feel to the paper art */
          filter: "blur(0.5px)" 
        }}
      />
...
export default function Assessment() {
  ...
  return (
    <>
      ...
      `}</style>
      <LibraryBackground />
      <div style={{ minHeight: "100vh", fontFamily: "Sans-Serif", display: "flex", alignItems: "flex-start", justifyContent: "center", padding: "70px 24px 80px", position: "relative", zIndex: 1 }}>
        <div style={{ width: "100%", maxWidth: "640px", marginTop: "0" }}>
          <header style={{ marginBottom: "32px", animation: "cardIn 0.4s ease" }}>
            <p style={{ fontSize: "12px", letterSpacing: "0.1em", textTransform: "uppercase", color: P.brown, fontWeight: "600", marginBottom: "6px", fontFamily: "'Fredoka', sans-serif" }}>Comprehension Check</p>
            <h1 style={{ fontSize: "36px", fontWeight: "700", color: P.text, letterSpacing: "-0.01em", lineHeight: "1.1", fontFamily: "'Fredoka', sans-serif" }}>{documentTitle || "Reading Assessment"}</h1>
          </header>
