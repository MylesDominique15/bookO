...
function LibraryBackground() {
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 0, pointerEvents: "none", overflow: "hidden" }}>
      ...
      <img 
        src="bookObg.png"  /* Ensure this matches your filename in /public exactly */
        ...
        style={{
          ...
          width: "100%",
          height: "auto",
          opacity: 0.35,      /* 35% transparency to match Assessment page */
          objectFit: "cover",
          filter: "blur(0.5px)" 
        }}
      />
  ...
  return (
    <>
      ...
      <div style={{
        ...
        position: "relative",
        zIndex: 1, 
        paddingTop: "30px" /* Spacing for the Nav */
      }}>
